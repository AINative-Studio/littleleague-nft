# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/littleleague-nft

**Score:** 🔴 2.1/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.2s
**Scanned:** 2026-06-01T21:40:00.879Z
...
- **[contributor-data-1]** 1 unique contributor with 6 commits in the last 12 months *(Single contributor detected — consider recruiting additional maintainers)*
...
- **[bus-factor-1]** Bus factor: 1, Elephant factor: 100% (1 contributors, 6 commits in last 12 months)
...
- **[license-compatibility-1]** Project license is GPL-3.0 — no installed dependencies to check compatibility
- **[vendor-neutrality-domain-count]** Found 1 unique email domain(s) across 6 commits
...
- **[AK-ACRONYM-NFT-README.md:2]** Undefined acronym "NFT" may confuse newcomers
...
---
*quaid-scanner v0.1.2 | 2026-06-01T21:40:00.879Z*
*Commit: 61f13d0dadce1afe3608bbb283744d7c14899dfc*